...
class testScanner implements java_cup.runtime.Scanner {
	...
	testScanner (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	testScanner (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -8:
						break;
					case 8:
						{ return new Symbol(testSymbol.NUMBER, Integer.parseInt(yytext()));}
					case -9:
						break;
					case 9:
